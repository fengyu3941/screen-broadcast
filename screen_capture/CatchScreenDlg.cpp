...
void CCatchScreenDlg::DrawTip()
{
	...
	{
		strTemp="\r\n\r\n ·Please keep left mouse down, \r\n  Move mouse to choose\r\n  an Area\r\n\r\n ·Click right mouse to quit";
	}
	else
	if(m_bDraw&&m_bFirstDraw)
	{
		strTemp="\r\n\r\n ·When left mouse up, the area is selected\r\n\r\n ·Click right mouse to abandon";
	}
	else
	if(m_bFirstDraw)
	{
		strTemp="\r\n\r\n ·You Can adjust the area with left mouse\r\n\r\n ·Double click left mouse in the area\r\n The area is chosen\r\n\r\n ·Click right mouse to abandon";
	}
	strOutput+=strTemp;
	//显示到编缉框中,操作提示窗口
	m_tipEdit.SetWindowText(strOutput);
	m_tipEdit.RedrawWindow();
}
